          ...
          <div class="row">
            <div class="large-10 columns">
              ...
              <div class="row">
               ...
               <div class="row">
                <div class="large-12 columns">
               <?php  echo form_password(array('name' => 'password','placeholder'=>'password', 'class' => 'mws-login-password mws-textinput', 'id' => 'password', 'value' => '')); ?>
                 </div>
              </div> 
             <div class="row">
                <div class="large-12 columns">
              ...
              <div class="row">
                <div class="large-12 columns"><?php echo form_submit(array('name' => 'submit', 'value' => 'Update', 'class' => 'button mainaction')); ?>
