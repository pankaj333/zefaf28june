...
$client->setRedirectUri('http://localhost/69wedding/g'); // paste the redirect URI where you given in APi Console. You will get the Access Token here during login success
